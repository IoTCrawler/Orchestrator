...
if [ "$1" = "install" ]; then
	...
	(if [ ! -d ~/.m2/repository/com/agtinternational/iotcrawler/fiware-models ]; then cd ../com.agtinternational.iotcrawler.fiware-models && sh make.sh install && cd com.agtinternational.iotcrawler.fiware-clients; fi);
